...
function re_render_book_table(searchTerm){
	...
	React.render(
		...
		React.createElement(EventButton, {className: "btn-primary", disabled: currentBook==undefined || currentBook.count == 0, buttonName: "ยืมหนังสือ"}), 
		React.createElement(EventButton, {className: "btn-danger", disabled: currentBook==undefined || currentBook.count == currentBook.maxCount, buttonName: "คืนหนังสือ"})
		),
