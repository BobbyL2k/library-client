...
var g_currentBook = {
	value: undefined,
	getCurrentBookId: function getCurrentBook(searchTerm){
	...
	setId: function setCurrentBook(currentBookId){
...
function re_render_book_table(searchTerm){
	...
	React.render(
		...
		React.createElement(EventButton, {className: "", disabled: g_currentBook, buttonName: "ยืมหนังสือ"}), 
		React.createElement(EventButton, {className: "", disabled: "", buttonName: "คืนหนังสือ"})
		),
